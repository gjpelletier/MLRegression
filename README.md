...
The MLRegression module includes five main functions, **stepwise**, **lasso**, **ridge**, **elastic**, and **stacking** to find the set of predictor variables that minimizes either the Mean Squared Error (MSE), Akaike Information Criterion (AIC), Bayesian Information Criterion (BIC), adjusted rsquared, or Variance Inflation Factors (VIF) in a multiple linear regression model.
...
The **stepwise** function in the MLRegression module has the option to use either forward selection (default), backward selection, or all subsets of possible combinations for the optimum set of predictor variables as follows using statsmodels OLS:
...
The **lasso** function in the MLRegression module provides output of regression models and summary statistics using the following methods using sklearn.linear_model:
...
The **ridge** function in the MLRegression module provides output of regression models and summary statistics using the following methods using sklearn.linear_model:
...
The **elastic** function in the MLRegression module provides output of the fitted regression model and summary statistics using the following method using sklearn.linear_model:
...
The **stacking** function in the MLRegression module provides output of a fitted regression model and summary statistics using the sklearn StackingRegressor function for ensemble modeling with any combination of sklearn base regressors which can be turned 'on' or 'off' with the following optional keyword arguments:
...
if you are upgrading from a previous installation of MLRegression, enter the following with pip pr !pip in your notebook or terminal:<br>
```
...
from MLRegression import lasso
...
# Use the stepwise function in the MLRegression module
from MLRegression import stepwise
...
# Use the ridge function in the MLRegression module
from MLRegression import ridge
...
# Use the elastic function in the MLRegression module
from MLRegression import elastic
...
# Use the stacking function in the MLRegression module
from MLRegression import stacking
